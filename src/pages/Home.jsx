    ...
    <div className="page">
      ...
      <section style={{
        ...
        <div style={{ position: 'absolute', inset: 0, overflow: 'hidden' }}>
          {SLIDES.map((slide, index) => (
            <div key={index} style={{
              ...
              <img src={slide.image} alt={slide.title} style={{ width: '100%', height: '100%', objectFit: 'cover', filter: 'brightness(0.95)' }} />
              <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(135deg, rgba(255,255,255,0.3) 0%, rgba(255,255,255,0.15) 100%)' }} />
            </div>
          ))}
        </div>
        ...
        <div style={{ position: 'relative', height: '100%' }}>
          {SLIDES.map((slide, index) => (
            <div key={index} style={{
              ...
              <div style={{ position: 'relative', zIndex: 2, maxWidth: 900, textAlign: 'center', marginTop: '40px' }}>
                <div style={{
                  ...
                  <div className="badge"><span className="badge-dot" /> Trusted by 500+ businesses globally</div>
                </div>

                <h1 style={{
                  fontSize: 'clamp(38px, 6vw, 64px)', lineHeight: 1.1, marginBottom: 24,
                  color: '#0d1022', fontWeight: 800,
                ...
                <p style={{
                  color: '#2d3154', fontSize: 19, lineHeight: 1.7, maxWidth: 650,
                  marginBottom: 36, marginLeft: 'auto', marginRight: 'auto', fontWeight: 500,
                  transform: index === currentSlide ? 'translateY(0)' : 'translateY(20px)',
                  opacity: index === currentSlide ? 1 : 0,
                  transition: 'transform 0.6s ease-out, opacity 0.6s',
                ...
                <div style={{
                  ...
                  <Link to="/services" className="btn btn-primary">{slide.ctaPrimary} <ArrowIcon /></Link>
                  <Link to="/about" className="btn btn-outline">{slide.ctaSecondary}</Link>
                </div>
              </div>
            </div>
          ))}
        ...
        <div style={{
          ...
          {SLIDES.map((_, index) => (
            <button key={index} onClick={() => setCurrentSlide(index)} style={{
              width: index === currentSlide ? 28 : 10, height: 10, borderRadius: 5, border: 'none',
        ...
        <div style={{
          ...
          boxShadow: '0 -2px 20px rgba(0,0,0,0.06)', zIndex: 5,
        }}>
          <div className="container">
            <div className="home-stats-row">
              {STATS.map(s => (
                <div key={s.label} style={{ textAlign: 'center' }}>
                  <div className="stat-num home-stat-num">{s.num}</div>
                  <div className="stat-lbl home-stat-lbl">{s.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <FadeInSection className="section section-alt">
        <div className="container">
          ...
          <div className="grid-3">
            ...
            <div className="card home-ipshopy-card" style={{ border: '2px solid #ff6b35', background: 'linear-gradient(135deg, rgba(255,107,53,0.03) 0%, rgba(255,107,53,0.08) 100%)' }}
              onClick={() => setShowEcommerceModal('marketplace')}
              onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(255,107,53,0.25)'; }}
            ...
            >
              ...
              <p style={{ fontSize: 13, color: 'var(--gray-500)', lineHeight: 1.65, marginBottom: 16, flex: 1 }}>0% commission marketplace platform with integrated shipping solutions.</p>
              <button style={{ background: 'linear-gradient(135deg, #ff6b35 0%, #ff8c42 100%)', color: 'white', border: 'none', padding: '10px 16px', borderRadius: 8, fontSize: 13, fontWeight: 600, cursor: 'pointer', marginTop: 'auto', boxShadow: '0 2px 8px rgba(255,107,53,0.3)' }}>Learn More →</button>
            </div>

            {/* IPShopy Seller Hub Card */}
            <div className="card home-ipshopy-card" style={{ border: '2px solid #1a3cff', background: 'linear-gradient(135deg, rgba(26,60,255,0.03) 0%, rgba(26,60,255,0.08) 100%)' }}
              onClick={() => setShowEcommerceModal('sellerhub')}
              onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(26,60,255,0.25)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'var(--shadow-sm)'; }}
            >
              ...
              <p style={{ fontSize: 13, color: 'var(--gray-500)', lineHeight: 1.65, marginBottom: 16, flex: 1 }}>Complete seller dashboard with analytics, inventory & order management.</p>
              <button style={{ background: 'linear-gradient(135deg, #1a3cff 0%, #0a1a6b 100%)', color: 'white', border: 'none', padding: '10px 16px', borderRadius: 8, fontSize: 13, fontWeight: 600, cursor: 'pointer', marginTop: 'auto', boxShadow: '0 2px 8px rgba(26,60,255,0.3)' }}>Learn More →</button>
            </div>

            {/* IPShopy Shipments Card */}
            <div className="card home-ipshopy-card" style={{ border: '2px solid #00b894', background: 'linear-gradient(135deg, rgba(0,184,148,0.03) 0%, rgba(0,184,148,0.08) 100%)' }}
              onClick={() => setShowEcommerceModal('shipments')}
              onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(0,184,148,0.25)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'var(--shadow-sm)'; }}
            >
              ...
              <p style={{ fontSize: 13, color: 'var(--gray-500)', lineHeight: 1.65, marginBottom: 16, flex: 1 }}>End-to-end logistics with real-time tracking and competitive rates.</p>
              <button style={{ background: 'linear-gradient(135deg, #00b894 0%, #00a383 100%)', color: 'white', border: 'none', padding: '10px 16px', borderRadius: 8, fontSize: 13, fontWeight: 600, cursor: 'pointer', marginTop: 'auto', boxShadow: '0 2px 8px rgba(0,184,148,0.3)' }}>Learn More →</button>
            </div>

            {/* Web Development */}
            <div className="card">
              <div className="icon-box"><svg viewBox="0 0 24 24"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg></div>
              <h3 style={{ fontSize: 16, marginBottom: 8 }}>Web Development</h3>
              <p style={{ fontSize: 13, color: 'var(--gray-500)', lineHeight: 1.65 }}>Custom web applications built with modern technologies for optimal performance and scalability.</p>
            </div>

            {/* Mobile App Development */}
            <div className="card">
              <div className="icon-box"><svg viewBox="0 0 24 24"><rect x="5" y="2" width="14" height="20" rx="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg></div>
              <h3 style={{ fontSize: 16, marginBottom: 8 }}>Mobile App Development</h3>
              <p style={{ fontSize: 13, color: 'var(--gray-500)', lineHeight: 1.65 }}>Native and cross-platform mobile solutions that deliver exceptional user experiences.</p>
            </div>

            {/* UI/UX Design */}
            <div className="card">
              <div className="icon-box"><svg viewBox="0 0 24 24"><path d="M12 19l7-7 3 3-7 7-3-3z"/><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><circle cx="11" cy="11" r="2"/></svg></div>
              <h3 style={{ fontSize: 16, marginBottom: 8 }}>UI/UX Design</h3>
              <p style={{ fontSize: 13, color: 'var(--gray-500)', lineHeight: 1.65 }}>User-centered design that combines aesthetics with functionality for maximum engagement.</p>
            </div>
          </div>
      ...
      {showEcommerceModal && (
        <div
          style={{
            ...
            WebkitBackdropFilter: 'blur(8px)', zIndex: 1000,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            padding: '16px',
          }}
        ...
        >
          <div
            style={{
              background: 'white', borderRadius: 20, maxWidth: 700, width: '100%',
          ...
          >
            {/* Close Button */}
            <button onClick={() => setShowEcommerceModal(null)} style={{
              ...
              onMouseEnter={(e) => { e.target.style.background = 'var(--gray-200)'; e.target.style.transform = 'rotate(90deg)'; }}
              onMouseLeave={(e) => { e.target.style.background = 'var(--gray-100)'; e.target.style.transform = 'rotate(0deg)'; }}
            >
            ...
            <div style={{
              ...
              padding: '40px 32px', borderRadius: '20px 20px 0 0',
              color: 'white', textAlign: 'center',
            }}>
              <div style={{ width: 64, height: 64, borderRadius: 16, background: 'rgba(255,255,255,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}>
              ...
              <h2 style={{ fontSize: 28, marginBottom: 8, fontWeight: 800 }}>
                {showEcommerceModal === 'marketplace' ? 'IPShopy Marketplace' : showEcommerceModal === 'sellerhub' ? 'IPShopy Seller Hub' : 'IPShopy Shipments'}
              </h2>
              <p style={{ fontSize: 16, opacity: 0.95 }}>
                {showEcommerceModal === 'marketplace' ? 'Your Gateway to E-commerce Success' : showEcommerceModal === 'sellerhub' ? 'Complete Seller Management Dashboard' : 'Smart Logistics & Shipping Solutions'}
              </p>
            </div>
            ...
            <div style={{ padding: '40px 32px' }}>
              <div style={{ marginBottom: 32 }}>
                ...
                {showEcommerceModal === 'marketplace' && (
                  <>
                    <p style={{ fontSize: 15, color: 'var(--gray-500)', lineHeight: 1.7, marginBottom: 16 }}>
                      We are revolutionizing online commerce with India's most seller-friendly marketplace platform. At IPShopy, we believe in empowering businesses by providing a seamless, cost-effective ecosystem where sellers can thrive without the burden of high commissions.
                    </p>
                    <div style={{ background: 'linear-gradient(135deg, rgba(255,107,53,0.08) 0%, rgba(255,140,66,0.08) 100%)', border: '1px solid rgba(255,107,53,0.2)', borderRadius: 12, padding: 20, marginBottom: 24 }}>
                ...
                {showEcommerceModal === 'sellerhub' && (
                  <>
                    <p style={{ fontSize: 15, color: 'var(--gray-500)', lineHeight: 1.7, marginBottom: 16 }}>
                      The IPShopy Seller Hub is your command center for managing your entire e-commerce business. From real-time analytics to inventory tracking and order management, everything you need to grow your business is available in one intuitive, easy-to-use dashboard.
                    </p>
                    <div style={{ background: 'linear-gradient(135deg, rgba(26,60,255,0.08) 0%, rgba(10,26,107,0.08) 100%)', border: '1px solid rgba(26,60,255,0.2)', borderRadius: 12, padding: 20, marginBottom: 24 }}>
                ...
                {showEcommerceModal === 'shipments' && (
                  <>
                    <p style={{ fontSize: 15, color: 'var(--gray-500)', lineHeight: 1.7, marginBottom: 16 }}>
                      IPShopy Shipments takes the complexity out of e-commerce logistics. Our integrated shipping solution provides competitive rates, real-time tracking, and reliable delivery partners to ensure your products reach customers safely and on time.
                    </p>
                    <div style={{ background: 'linear-gradient(135deg, rgba(0,184,148,0.08) 0%, rgba(0,163,131,0.08) 100%)', border: '1px solid rgba(0,184,148,0.2)', borderRadius: 12, padding: 20, marginBottom: 24 }}>
              ...
              <div style={{ marginBottom: 32 }}>
                ...
                <div style={{ display: 'grid', gap: 16 }}>
                  {(showEcommerceModal === 'marketplace' ? [
                    ...
                    <div key={idx} style={{ display: 'flex', gap: 16, padding: 16, borderRadius: 12, background: 'var(--gray-50)', border: '1px solid var(--gray-100)', transition: 'transform 0.2s' }}
              ...
              <div style={{
                background: showEcommerceModal === 'marketplace'
                  ...
                  ? 'linear-gradient(135deg, #1a3cff 0%, #0a1a6b 100%)'
                  : 'linear-gradient(135deg, #00b894 0%, #00a383 100%)',
                borderRadius: 16, padding: 28, textAlign: 'center', color: 'white',
              }}>
                <h3 style={{ fontSize: 20, marginBottom: 8 }}>
                  {showEcommerceModal === 'marketplace' ? 'Ready to Start Selling?' : showEcommerceModal === 'sellerhub' ? 'Ready to Grow Your Business?' : 'Ready to Simplify Shipping?'}
                </h3>
                <p style={{ fontSize: 14, marginBottom: 20, opacity: 0.9 }}>
                  {showEcommerceModal === 'marketplace' ? 'Join thousands of successful sellers on IPShopy.com' : showEcommerceModal === 'sellerhub' ? 'Get access to powerful seller tools and analytics' : 'Start shipping with confidence today'}
                </p>
                <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
                  <a href="https://www.ipshopy.com" target="_blank" rel="noopener noreferrer"
                    style={{
                      background: 'white',
                      color: showEcommerceModal === 'marketplace' ? '#ff6b35' : showEcommerceModal === 'sellerhub' ? '#1a3cff' : '#00b894',
                      padding: '12px 28px', borderRadius: 9, fontSize: 14, fontWeight: 600,
                      textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 6, transition: 'transform 0.2s',
                    }}
                    onMouseEnter={(e) => { e.target.style.transform = 'translateY(-2px)'; e.target.style.boxShadow = '0 4px 12px rgba(255,255,255,0.3)'; }}
                    onMouseLeave={(e) => { e.target.style.transform = 'translateY(0)'; e.target.style.boxShadow = 'none'; }}
                  >
                    {showEcommerceModal === 'marketplace' ? 'Visit IPShopy.com' : showEcommerceModal === 'sellerhub' ? 'Access Seller Hub' : 'Explore Shipments'}
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>
                      <polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/>
                    </svg>
                  </a>
                  <button onClick={() => setShowEcommerceModal(null)} style={{ background: 'rgba(255,255,255,0.2)', color: 'white', padding: '12px 28px', borderRadius: 9, fontSize: 14, fontWeight: 600, border: '1.5px solid rgba(255,255,255,0.4)', cursor: 'pointer' }}>Close</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <style>{`
        ...
        .home-about-img-wrap { padding-right: 10px; }
        .home-about-img {
          border-radius: 2px;
          width: 80%;
          object-fit: cover;
        ...
        .home-about-text-wrap { padding-left: 40px; }
        ...
        @media (max-width: 768px) {
          ...
          /* Hero slider: reduce top padding so content isn't hidden */
          section[style*="minHeight: '90vh'"] > div:nth-child(3) > div > div {
            padding: 90px 20px 60px !important;
          }

          /* Nav arrows: smaller & closer to edge */
          ...
          .home-stat-num { font-size: 26px !important; }
          .home-stat-lbl { font-size: 12px !important; }
